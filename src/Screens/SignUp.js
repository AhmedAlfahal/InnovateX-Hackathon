...
import {Text, View, Button, StyleSheet, LogBox} from 'react-native';
		...
		<View style={buttonStyle}>
		 <Button
			...
			onPress={() =>{
				...
				Tts.speak('We have detected TalkBack and High Contrast is enabled. Speech Recognization and Black And White Mode has been enabled.');
